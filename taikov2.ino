...
void loop() {                //DL..DR..KL..KR
 ...
 unsigned int sensorValue[] = {analogRead(DON_L), analogRead(D0N_R), analogRead(KA_L), analogRead(KA_R)}; // reading inputs. using analogRead isn`t optimal for this but it works good enough :P 
